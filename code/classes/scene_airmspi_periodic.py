                ...
                for seg in range(N_seg):
                    ...
                    for k in range(N_cams):
                        ...
                        if pixel[0] != 65535:
                            ...
                            # distance_to_camera = math.sqrt(distance_to_camera)
                            # if volumetric_scattering:
                            ...
                            # else:
                            #     cos_theta = cam_direction[2]
                            #     le_pdf = (sea_albedo*cos_theta)/np.pi
                            # pc = (1 / (distance_to_camera *distance_to_camera)) * IS * le_pdf * attenuation
                            pc = (1 / (distance_to_camera )) * IS * le_pdf * attenuation
                            if is_in_medium[k]:
                ...
                for seg in range(N_seg):
                    ...
                    for sub_seg in range(seg, N_seg):
                        ...
                        for k in range(path_contrib.shape[0]):
                            ...
                            if pixel[0] != 65535 and k != exclude_ind:
