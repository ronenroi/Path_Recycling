...
for file in files:
    ...
    if tensorboard:
        ...
        cp_wrapper = CheckpointWrapper(scene_rr, optimizer, Np_gt*N_render_gt, Np, rr_depth, rr_stop_prob, pss, I_gts, resample_freq, step_size, iterations,
    ...
    for iter in range(iterations):
        ...
        for i in range(2):
            ...
            cloud['total_grad_it_{}_{}'.format(iter, i)] = csr_matrix(total_grad.ravel())#.tolist()
    ...
    with open('generated_data/cloud{}.pkl'.format(i_cloud), 'wb') as f:
        print(f"saving cloud data")
