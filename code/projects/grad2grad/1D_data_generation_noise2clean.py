...
for file in files:
    ...
    output_dir = "1D_generated_data_noise2clean/cloud{}".format(i_cloud)
    ...
    for iter in range(iterations):
        ...
        with open('{}/beta_opt_it_{}_Np_{}.pkl'.format(output_dir,iter,int(Np)), 'wb') as f:
            pickle.dump(beta_opt, f, protocol=pickle.HIGHEST_PROTOCOL)
    ...
    plt.plot(np.squeeze(beta_opt), altitude)
