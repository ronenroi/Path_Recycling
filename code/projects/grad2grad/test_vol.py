...
if __name__ == '__main__':
    ...
    Thread.thread().file_resolver().append('vol')
    scene = load_file('/home/roironen/mitsuba2/resources/data/tests/scenes/participating_media/test_hetero_sigmat.xml')
    # Find differentiable scene parameters
    params = traverse(scene)
    # Discard all parameters except for one we want to differentiate
    params.keep(['medium1.sigma_t.data'])
    ...
    # image_ref = render_torch(scene, spp=50)
    crop_size = scene.sensors()[0].film().crop_size()
    # write_bitmap('/home/roironen/mitsuba2/projects/dev/grad2grad/test_output/out_ref.png', image_ref, crop_size)
    # torch.save(image_ref,'/home/roironen/mitsuba2/projects/dev/grad2grad/test_output/vol_img.pt')
    image_ref = torch.load('/home/roironen/mitsuba2/projects/dev/grad2grad/test_output/vol_img.pt')
    ...
    for use_nn in [False]:
        ...
        for it in range(iterations):
            ...
            image = render_torch(scene, params=params, unbiased=False,
            ...
            if use_nn:
                ...
                write_bitmap('/home/roironen/mitsuba2/projects/dev/grad2grad/test_output/clean_out_%03i.png' % it,
                             image, crop_size)
